...
const SkillInfo* SkillManager::GetSkill(int _slot, eSkillName _type) const
{
    std::map<eSkillName, SkillInfo*>::const_iterator iter = m_mapSkill.find(_type);
...
{
    std::map<eSkillName, SkillInfo*>::const_iterator iter = m_mapSkill.cbegin();
    std::map<eSkillName, SkillInfo*>::const_iterator iterEnd = m_mapSkill.cend();
